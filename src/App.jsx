...
const App = () => {
  ...
  const handleAvgClick = (event) => {
    ...
    for (let i = 0; i < carData.length; i++) {
      if (
        Number(carData[i].Year) === yearNumber &&
    ...
    for (let j = 0; j < carData.length; j++) {
      if (
        Number(carData[j].Year) === historicalIncrease &&
  ...
  return (
    <>
      <Container>
        ...
        >
          <Typography variant="h4" sx={{ p: "8px" }}>
            What's your Carbon Dioxide Birth Number?
          </Typography>
          <Typography variant="h5" sx={{ mb: "32px", marginLeft: "7px" }}>
            Select your birth information to find out!
          </Typography>

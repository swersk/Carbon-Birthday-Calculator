...
const ResultsCards = ({ month, year, avg, increase, difference, trend }) => {
  ...
  return (
    <>
      <Grid container container sx={{ padding: "50px", "& > div": { padding: "10px" } }}>
...
{/* <Box sx={{display: 'flex', flexDirection: 'row', border: '5px solid pink'}}>
<Grid container spacing={2}>
  <Grid item xs={3} sx={{border: '1px solid orange'}}>
      <Typography>Hi!</Typography>
  </Grid>
  <Grid item xs={3} sx={{border: '1px solid brown'}}>
      <Typography>Hi!!</Typography>
  </Grid>
